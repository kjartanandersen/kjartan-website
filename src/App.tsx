  ...
  return (
    <NavBar activeComp="home">
      <div className="home">
        ...
        <a id="home-about-href" href="#home-about-href" className="home-link-to-about-me">
          <img src={hrefImage} />
        </a>
        <div className="home-content">
          <div className="home-info">
            ...
            <div  className="home-aboutme">
              ...
              <p>
                I am a Software Developer, born and raised in Reykjavík, Iceland
                and currently living there, currently looking for work.
              </p>
              <p>
                I am passionate about programming, and I always strive to make
                high quality, readable and well documented code. I can work with
                other people, I am very flexible, initiative, confident and very
                friendly.
              </p>
              <p>
                I am mostly interested in Full-Stack Web Development and Game
                Development, but I always love to stay up to date on the latest
